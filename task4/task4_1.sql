DROP DATABASE IF EXISTS task4_1;
CREATE DATABASE IF NOT EXISTS task4_1;
USE task4_1;
...
SELECT 
	g.gr_name AS 'Группа анализов', 
	a.an_name AS 'Наименование анализов', 
	a.an_price AS 'Стоимость процедуры', 
	ord_datetime AS 'Дата'
FROM Analysis AS a
JOIN GroupsAn AS g
ON a.an_group = g.gr_id
JOIN Orders AS o
ON 
	(o.ord_datetime >= '20200205' AND o.ord_datetime <= '20200206') 
    OR 
    (o.ord_datetime BETWEEN '20200210' AND '20200217'); 
