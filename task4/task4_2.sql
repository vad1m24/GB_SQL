DROP DATABASE IF EXISTS task4_2;
CREATE DATABASE IF NOT EXISTS task4_2;
USE task4_2;
...
SELECT MARK AS 'Марка авто',
	(SELECT COUNT(*) FROM AUTO) - COUNT(MARK) AS 'Количество иных авто'
FROM AUTO
GROUP BY MARK;
